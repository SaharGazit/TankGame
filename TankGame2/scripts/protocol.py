...
1. Both clients randomly generate a number between 0-2. (0 = rock, 1 = paper, 2 = scissors)
...
3. The highest number wins, except 0 defeats 2, since the game is circular.
